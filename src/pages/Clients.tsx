...
export default function Clients() {
  ...
  const getStatusBadge = (status: string) => {
    return getClientStatusBadgeClasses(status);
  };
        ...
        <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
          ...
          <Card>
            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
              ...
              <Users
                className={cn("h-4 w-4", getClientStatusColor("active"))}
              />
            </CardHeader>
            <CardContent>
              <div
          ...
          <Card>
            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
              ...
              <Users className={cn("h-4 w-4", getClientStatusColor("lead"))} />
            </CardHeader>
            <CardContent>
              <div
                className={cn(
                  "text-2xl font-bold",
                  getClientStatusColor("lead")
                )}
              >
                {leads}
              </div>
          ...
          <Card>
            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
              ...
              <Users
                className={cn("h-4 w-4", getClientStatusColor("inactive"))}
              />
            </CardHeader>
            <CardContent>
              <div
